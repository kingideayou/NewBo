...
public class Style {
    ...
    public static final int holoNewBoLight = 0xff03a9f4;
    ...
    public static final Style NEWBO;
    ...
    static {
        ...
        INFO = new Builder()
                ...
                .build();
        NEWBO = new Builder()
                .setBackgroundColorValue(holoNewBoLight)
                .build();
    }
    ...
    /** The {@link ImageView.ScaleType} for the image to display in the {@link de.keyboardsurfer.android.widget.crouton.Crouton}. */
    ...
    public static class Builder {
        ...
        /**
         * Set the {@link Configuration} option of the {@link de.keyboardsurfer.android.widget.crouton.Crouton}.
         *
         * @param configuration
