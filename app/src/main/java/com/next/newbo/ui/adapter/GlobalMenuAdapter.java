...
public class GlobalMenuAdapter extends ArrayAdapter<GlobalMenuAdapter.GlobalMenuItem> {
    ...
    private void setupMenuItems() {
        menuItems.add(new GlobalMenuItem(R.mipmap.ic_global_menu_feed, "我的微博"));
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(getItemViewType(position) == TYPE_MENU_ITEM) {
            ...
            if(convertView == null) {
                convertView  = inflater.inflate(R.layout.item_global_menu, null);
            ...
            return inflater.inflate(R.layout.item_menu_divider, null);
        }
    }
